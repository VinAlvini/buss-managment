                        ...
                        <div class="col-xl-10">
                            <div class="profile__content__edit p-0">
                                ...
                                <div class="row gy-3 p-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="lastname" class="form-label">@lang('National ID')</label>
                                            <input type="text" class="form-contorl form--control radius-0" id="nin" name="nin" placeholder="@lang('National ID')" value="{{$user->nin}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
